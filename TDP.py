...
<body>
    ...
    <div class="control-panel">
        <div style="flex: 1; min-width: 200px;">
            ...
            <div id="status-msg" style="font-size: 11px; color: #94a3b8; margin-top: 2px;">(Kéo ghim hoặc bấm nút dưới để lấy GPS)</div>
        </div>
        <div class="btn-group">
...
try:
    ...
    if btn_calc or "last_search_df" in st.session_state:
            ...
            if len(parts) >= 2:
                try:
                    ...
                    with st.spinner("Đang tính toán khoảng cách..."):
                        ...
                        # Tạo link Google Maps: xem vị trí và chỉ đường
        ...
        if top_res is not None and not top_res.empty:
            ...
            # ==================== KHU VỰC XUẤT DỮ LIỆU & TỌA ĐỘ ====================
            col_exp1, col_exp2 = st.columns([1, 1])

            with col_exp1:
                # Xuất file CSV / Excel chứa trọn bộ thông tin + link Google Maps
                export_cols = [
                    "Kết quả",
                    "Khoảng cách (m)",
                    col_ma_tram,
            ...
            with col_exp2:
                # Textbox chứa danh sách tọa độ sạch để copy nhanh
                coords_text_export = "\n".join(
                    [
